...
namespace VRBoxingGame.Testing
{
    ...
    public class EndToEndUserTesting : MonoBehaviour
    {
        ...
        private IEnumerator TestMenuNavigation()
        {
            ...
            // Find menu system
            var optimizedMenu = FindObjectOfType<EnhancedMainMenuSystemOptimized>();
            var enhancedMenu = FindObjectOfType<EnhancedMainMenuSystem>();
        ...
        private IEnumerator TestVRCompatibility()
        {
            ...
            // Test hand tracking
            var handTracking = FindObjectOfType<VRBoxingGame.HandTracking.HandTrackingManager>();
            ...
            var vrPerformance = FindObjectOfType<VRBoxingGame.Performance.VRPerformanceMonitor>();
        ...
        private IEnumerator ApplyEmergencyFixes()
        {
            ...
            // Apply QuickSceneFix
            var sceneFix = FindObjectOfType<QuickSceneFix>();
            if (sceneFix == null)
            {
            ...
            // Apply MenuSystemFix
            var menuFix = FindObjectOfType<MenuSystemFix>();
            if (menuFix == null)
            {
