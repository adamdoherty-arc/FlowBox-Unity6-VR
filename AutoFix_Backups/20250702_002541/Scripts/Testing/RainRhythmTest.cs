...
namespace VRBoxingGame.Testing
{
    ...
    public class RainRhythmTest : MonoBehaviour
    {
        ...
        private void SetupRainEnvironment()
        {
            ...
            rainScene = CachedReferenceManager.Get<RainSceneCreator>();
            if (rainScene == null)
            {
        ...
        private void SetupVRRig()
        {
            ...
            vrSetup = CachedReferenceManager.Get<VRSceneSetup>();
            if (vrSetup == null)
            {
        ...
        private void SetupAudioSystem()
        {
            ...
            testTrack = CachedReferenceManager.Get<TestTrack>();
            if (testTrack == null)
            {
        ...
        private void SetupTargetSystem()
        {
            ...
            var prefabCreator = CachedReferenceManager.Get<CirclePrefabCreator>();
        ...
        private void SetupGameUI()
        {
            ...
            gameUI = CachedReferenceManager.Get<GameUI>();
            if (gameUI == null)
            {
