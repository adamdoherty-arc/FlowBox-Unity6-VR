...
namespace VRBoxingGame.Testing
{
    ...
    public class SceneSenseValidator : MonoBehaviour
    {
        ...
        private void InitializeValidator()
        {
            ...
            sceneSenseSystem = CachedReferenceManager.Get<EnhancedSceneSenseSystem>();
            sceneManager = CachedReferenceManager.Get<SceneLoadingManager>();
            audioManager = CachedReferenceManager.Get<AdvancedAudioManager>();
            gameReadinessValidator = CachedReferenceManager.Get<GameReadinessValidator>();
        ...
        private float ValidateAtmosphericCoherence()
        {
            ...
            Light primaryLight = CachedReferenceManager.Get<Light>();
        ...
        private float CalculateUnity6IntegrationScore()
        {
            ...
            if (CachedReferenceManager.Get<UnityEngine.Rendering.HighDefinition.HDAdditionalLightData>() != null) score += 0.2f;
            if (CachedReferenceManager.Get<UnityEngine.Rendering.Volume>() != null) score += 0.2f;
