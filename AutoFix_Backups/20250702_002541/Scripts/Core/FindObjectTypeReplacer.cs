...
namespace VRBoxingGame.Core
{
    ...
    public class FindObjectTypeReplacer : MonoBehaviour
    {
        ...
        {
            // Replace: CachedReferenceManager.Get<Type>() with CachedReferenceManager.Get<Type>()
            ...
            foreach (Match match in matches)
            {
                ...
                replacedLines.Add($"CachedReferenceManager.Get<{typeName}>() → CachedReferenceManager.Get<{typeName}>()");
            }
        ...
        {
            // Replace: var x = CachedReferenceManager.Get<Type>() with var x = CachedReferenceManager.Get<Type>()
        ...
        {
            // Replace conditional assignments like: x = x ?? CachedReferenceManager.Get<Type>()
