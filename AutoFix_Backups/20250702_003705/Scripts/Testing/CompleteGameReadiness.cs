...
namespace VRBoxingGame.Testing
{
    ...
    public class CompleteGameReadiness : MonoBehaviour
    {
        ...
        private IEnumerator SetupGameAssets()
        {
            ...
            Material whiteMaterial = Resources.Load<Material>("WhiteCircleMaterial");
            Material grayMaterial = Resources.Load<Material>("GrayCircleMaterial");
            Material blockMaterial = Resources.Load<Material>("RedBlockMaterial");
