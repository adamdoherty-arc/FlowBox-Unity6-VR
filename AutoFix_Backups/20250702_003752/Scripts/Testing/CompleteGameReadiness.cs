...
namespace VRBoxingGame.Testing
{
    ...
    public class CompleteGameReadiness : MonoBehaviour
    {
        ...
        private IEnumerator SetupGameAssets()
        {
            ...
            Material whiteMaterial = // TODO: Convert to Addressables - Resources.Load<Material>("WhiteCircleMaterial");
            Material grayMaterial = // TODO: Convert to Addressables - Resources.Load<Material>("GrayCircleMaterial");
            Material blockMaterial = // TODO: Convert to Addressables - Resources.Load<Material>("RedBlockMaterial");
