...
namespace VRBoxingGame.UI
{
    ...
    public class EnhancedMainMenuSystem : MonoBehaviour
    {
        ...
        private async void ShowPanel(GameObject panel)
        {
            HideAllPanels();
            if (panel != null)
            {
        ...
        public async void ConnectAppleMusic()
        {
            PlayUISound(1);
        ...
        public async void ConnectYouTubeMusic()
        {
            PlayUISound(1);
        ...
        public async void ConnectSpotify()
        {
            PlayUISound(1);
        ...
        private void ApplyComfortSettings(float comfortLevel)
        {
            ...
            var vrOrigin = FindObjectOfType<Unity.XR.CoreUtils.XROrigin>();
            if (vrOrigin != null)
            {
        ...
        private void ApplyColorBlindSettings(bool enabled)
        {
            if (enabled)
            {
                ...
                var targetSystem = FindObjectOfType<RhythmTargetSystem>();
