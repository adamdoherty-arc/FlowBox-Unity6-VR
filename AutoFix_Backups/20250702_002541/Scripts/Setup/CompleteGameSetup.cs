...
namespace VRBoxingGame.Setup
{
    ...
    public class CompleteGameSetup : MonoBehaviour
    {
        ...
        private void SetupCoreGameSystems()
        {
            ...
            // Object Pool Manager
            if (CachedReferenceManager.Get<ObjectPoolManager>() == null)
            {
        ...
        private void SetupAudioSystems()
        {
            ...
            // Test Track
            if (CachedReferenceManager.Get<TestTrack>() == null)
            {
        ...
        private void ConnectSystems()
        {
            ...
            AdvancedTargetSystem advancedTargets = CachedReferenceManager.Get<AdvancedTargetSystem>();
        ...
        {
            bool exists = CachedReferenceManager.Get<T>() != null;
