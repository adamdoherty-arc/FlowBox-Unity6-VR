        ...
        private void InitializePerformanceTracking()
        {
         ...
         private void InitializeBoxingSystems()
         {
             if (boxingTargetSystem == null)
                 boxingTargetSystem = CachedReferenceManager.Get<AdvancedTargetSystem>();
         }
         
         private void InitializeAudioSystems()
         {
             if (musicReactiveSystem == null)
                 musicReactiveSystem = CachedReferenceManager.Get<MusicReactiveSystem>();
         }
         
         private void InitializeEnvironmentSystems()
         {
             if (sceneTransformationSystem == null)
                 sceneTransformationSystem = CachedReferenceManager.Get<SceneTransformationSystem>();
         }
         
         private void InitializeHandTracking()
         {
             if (handTrackingManager == null)
                 handTrackingManager = CachedReferenceManager.Get<HandTrackingManager>();
         }
