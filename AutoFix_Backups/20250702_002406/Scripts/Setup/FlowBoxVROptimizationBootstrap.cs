...
namespace VRBoxingGame.Setup
{
    ...
    public class FlowBoxVROptimizationBootstrap : MonoBehaviour
    {
        ...
        private IEnumerator SetupInputSystemMigration()
        {
            ...
            inputMigrator = FindObjectOfType<LegacyInputSystemMigrator>();
        ...
        private IEnumerator EnableAdvancedSystems()
        {
            ...
            var addressableSystem = FindObjectOfType<VRBoxingGame.Streaming.AddressableStreamingSystem>();
            if (addressableSystem != null)
            {
                Debug.Log("✅ Addressable Streaming System found");
            }
            
            var optimizedUpdateManager = FindObjectOfType<OptimizedUpdateManager>();
        ...
        private string GenerateValidationReport()
        {
            ...
            var renderGraph = FindObjectOfType<VRRenderGraphSystem>();
            var addressable = FindObjectOfType<VRBoxingGame.Streaming.AddressableStreamingSystem>();
            var updateManager = FindObjectOfType<OptimizedUpdateManager>();
