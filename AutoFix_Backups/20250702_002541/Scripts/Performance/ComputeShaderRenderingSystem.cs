        ...
        private async System.Threading.Tasks.Task LoadDefaultComputeShadersAsync()
        {
            if (cullingComputeShader == null)
            {
                ...
                catch (System.Exception ex)
                {
                    ...
                    cullingComputeShader = // TODO: Convert to Addressables - Resources.Load<ComputeShader>("ComputeShaders/InstancedCulling");
                }
            }
            ...
            if (instancedRenderingShader == null)
            {
                ...
                catch (System.Exception ex)
                {
                    ...
                    // Fallback to Resources
                    instancedRenderingShader = // TODO: Convert to Addressables - Resources.Load<ComputeShader>("ComputeShaders/InstancedRendering");
                }
            }
